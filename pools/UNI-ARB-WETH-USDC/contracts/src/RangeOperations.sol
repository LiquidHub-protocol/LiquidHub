...
library RangeOperations {
    ...
    /// @dev Helper interne reutilisable depuis d'autres fonctions de la library (oracleMinOut
    ///      external ne peut pas etre appelee directement par une autre fonction de la meme lib).
