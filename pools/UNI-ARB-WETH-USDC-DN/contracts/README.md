...
| **RangeStrategyEngine.sol** | Per-pool Delta Neutral decision engine. Adds hedge drift, borrow conditions and current/stressed health-factor constraints to the common analytical and multi-scenario decision. |
